...
function dutyFree(normPrice, discount, hol){
  ...
  //Math.floor() will round the value down, making sure we don't go past the holiday amount
  //Since we are trying to obtain how many bottles we can purchase on a discount, We need rearrange the equation to obtain the correct value.
}
// dutyFree(12, 50, 1000) => Math.floor((1000 / (12 * (50 / 100)))) ==> 166 this sample function call should return 166, which is the number of bottles I can buy at price $12, discounted 50%, and in my $1000 budget
